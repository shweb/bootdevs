                                ...
                                <li>
                                    <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="{{ asset("/metronic/theme/assets/layouts/layout3/img/avatar2.jpg") }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="{{ asset("/metronic/theme/assets/layouts/layout3/img/avatar3.jpg") }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="{{ asset("/metronic/theme/assets/layouts/layout3/img/avatar1.jpg") }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
