...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <div id="site_statistics_loading">
                                        <img src="{{ asset("/metronic/theme/assets/global/img/loading.gif") }}" alt="loading" /> </div>
                                            ...
                                            <div class="mt-comments">
                                                <div class="mt-comment">
                                                    <div class="mt-comment-img">
                                                        <img src="{{ asset("/metronic/theme/assets/pages/media/users/avatar1.jpg") }}" /> </div>
                                                ...
                                                <div class="mt-comment">
                                                    <div class="mt-comment-img">
                                                        <img src="{{ asset("/metronic/theme/assets/pages/media/users/avatar6.jpg") }}" /> </div>
                                                    <div class="mt-comment-body">
                                                        <div class="mt-comment-info">
                                                ...
                                                <div class="mt-comment">
                                                    <div class="mt-comment-img">
                                                        <img src="{{ asset("/metronic/theme/assets/pages/media/users/avatar8.jpg") }}" /> </div>
                                                    <div class="mt-comment-body">
                                                        <div class="mt-comment-info">
                                                ...
                                                <div class="mt-comment">
                                                    <div class="mt-comment-img">
                                                        <img src="{{ asset("/metronic/theme/assets/pages/media/users/avatar4.jpg") }}" /> </div>
                                                    <div class="mt-comment-body">
                                                        <div class="mt-comment-info">
                                    ...
                                    <div class="tab-content">
                                            ...
                                            <div class="mt-actions">
                                                <div class="mt-action">
                                                    <div class="mt-action-img">
                                                        <img src="{{ asset("/metronic/theme/assets/pages/media/users/avatar10.jpg") }}" /> </div>
                                                ...
                                                <div class="mt-action">
                                                    <div class="mt-action-img">
                                                        <img src="{{ asset("/metronic/theme/assets/pages/media/users/avatar3.jpg") }}" /> </div>
                                                    <div class="mt-action-body">
                                                        <div class="mt-action-row">
                                                            <div class="mt-action-info ">
                                                                <div class="mt-action-icon ">
                                                ...
                                                <div class="mt-action">
                                                    <div class="mt-action-img">
                                                        <img src="{{ asset("/metronic/theme/assets/pages/media/users/avatar2.jpg") }}" /> </div>
                                                    <div class="mt-action-body">
                                                        <div class="mt-action-row">
                                                            <div class="mt-action-info ">
                                                                <div class="mt-action-icon ">
                                                ...
                                                <div class="mt-action">
                                                    <div class="mt-action-img">
                                                        <img src="{{ asset("/metronic/theme/assets/pages/media/users/avatar7.jpg") }}" /> </div>
                                                    <div class="mt-action-body">
                                                        <div class="mt-action-row">
                                                            <div class="mt-action-info ">
                                                                <div class="mt-action-icon ">
                                                ...
                                                <div class="mt-action">
                                                    <div class="mt-action-img">
                                                        <img src="{{ asset("/metronic/theme/assets/pages/media/users/avatar9.jpg") }}" /> </div>
                                                    <div class="mt-action-body">
                                                        <div class="mt-action-row">
                                                            <div class="mt-action-info ">
                                                                <div class="mt-action-icon ">
                                        ...
                                        <div class="tab-pane" id="tab_actions_completed">
                                            ...
                                            <div class="mt-actions">
                                                ...
                                                <div class="mt-action">
                                                    <div class="mt-action-img">
                                                        <img src="{{ asset("/metronic/theme/assets/pages/media/users/avatar5.jpg") }}" /> </div>
                                                    <div class="mt-action-body">
                                                        <div class="mt-action-row">
                                                            <div class="mt-action-info ">
                                                                <div class="mt-action-icon ">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body" id="chats">
                                    <div class="scroller" style="height: 525px;" data-always-visible="1" data-rail-visible1="1">
                                        <ul class="chats">
                                            <li class="out">
                                                <img class="avatar" alt="" src="{{ asset("/metronic/theme/assets/layouts/layout/img/avatar2.jpg") }}" />
                                                <div class="message">
                                            ...
                                            <li class="in">
                                                <img class="avatar" alt="" src="{{ asset("/metronic/theme/assets/layouts/layout/img/avatar1.jpg") }}" />
                                                <div class="message">
                                                    <span class="arrow"> </span>
                                            ...
                                            <li class="out">
                                                <img class="avatar" alt="" src="{{ asset("/metronic/theme/assets/layouts/layout/img/avatar3.jpg") }}" />
                                                <div class="message">
                                                    <span class="arrow"> </span>
                            ...
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="{{ asset("/metronic/theme/assets/layouts/layout/img/avatar3.jpg") }}" alt="...">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="{{ asset("/metronic/theme/assets/layouts/layout/img/avatar1.jpg") }}" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="{{ asset("/metronic/theme/assets/layouts/layout/img/avatar4.jpg") }}" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="{{ asset("/metronic/theme/assets/layouts/layout/img/avatar2.jpg") }}" alt="...">
                                        <div class="media-body">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="{{ asset("/metronic/theme/assets/layouts/layout/img/avatar6.jpg") }}" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="{{ asset("/metronic/theme/assets/layouts/layout/img/avatar7.jpg") }}" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="{{ asset("/metronic/theme/assets/layouts/layout/img/avatar8.jpg") }}" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="{{ asset("/metronic/theme/assets/layouts/layout/img/avatar9.jpg") }}" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="{{ asset("/metronic/theme/assets/layouts/layout/img/avatar10.jpg") }}" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="{{ asset("/metronic/theme/assets/layouts/layout/img/avatar11.jpg") }}" alt="...">
                                        <div class="media-body">
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2016 &copy; Yubis IT Solutions LTD.
        ...
        <!-- END FOOTER -->
        <!--[if lt IE 9]>
<script src="{{ asset("/metronic/theme/assets/global/plugins/respond.min.js") }}"></script>
<script src="{{ asset("/metronic/theme/assets/global/plugins/excanvas.min.js") }}"></script> 
<![endif]-->
        @include('js-plugin')
    </body>
